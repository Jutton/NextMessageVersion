...
@synthesize nextMessageViewController;
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndexafter
{
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if (buttonIndex == 1) {
        ...
        [message addAttributeWithName:@"to" stringValue:self.currentUser.jidStr];
...
//			[alertView show];
            ...
            self.messageViewController.responseView.text = body;
