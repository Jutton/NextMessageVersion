...
@class NextMessageViewController;
...
@property (strong, nonatomic) IBOutlet MessageViewController *messageViewController;

@property (weak, nonatomic) IBOutlet NextMessageViewController *nextMessageViewController;
