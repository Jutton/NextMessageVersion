...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"My special value is:%@", delegate.currentUser.nickname);
...
//[alertView show];
[self.navigationController presentViewController:[[self appDelegate] messageViewController] animated:YES completion:NULL];
}
